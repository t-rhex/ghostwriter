...
echo "[1/8] Building Ghostwriter.app..."
cd "$PROJECT_DIR"
bash Scripts/bundle.sh

# 2. Install the .app bundle
echo "[2/8] Installing $APP_NAME to $APP_INSTALL_DIR..."
...
echo "[3/8] Installing server files..."
...
# 5. Validate Java is available (required by LanguageTool)
